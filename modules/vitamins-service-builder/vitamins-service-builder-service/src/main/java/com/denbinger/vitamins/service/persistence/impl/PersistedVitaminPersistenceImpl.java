...
import com.denbinger.vitamins.service.persistence.impl.constants.NEBPersistenceConstants;
...
public class PersistedVitaminPersistenceImpl
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(
				entityCacheEnabled, PersistedVitaminImpl.class, primaryKey);
		}
	}
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.denbinger.vitamins.model.PersistedVitamin"),
			true);
	}
