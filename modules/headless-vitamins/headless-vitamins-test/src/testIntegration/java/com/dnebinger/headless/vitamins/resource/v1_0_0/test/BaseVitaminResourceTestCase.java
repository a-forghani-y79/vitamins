...
import com.dnebinger.headless.vitamins.client.dto.v1_0_0.Vitamin;
...
import com.dnebinger.headless.vitamins.client.resource.v1_0_0.VitaminResource;
import com.dnebinger.headless.vitamins.client.serdes.v1_0_0.VitaminSerDes;
...
public abstract class BaseVitaminResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		Assert.assertEquals(regex, vitamin.getArtcleId());
	...
	protected void assertValid(Vitamin vitamin) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("artcleId", additionalAssertFieldName)) {
			...
			if (Objects.equals("chemicalName", additionalAssertFieldName)) {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (Field field :
				getDeclaredFields(
					com.dnebinger.headless.vitamins.dto.v1_0_0.Vitamin.class)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("artcleId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						vitamin1.getArtcleId(), vitamin2.getArtcleId())) {
			...
			if (Objects.equals("chemicalName", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						vitamin1.getChemicalName(),
						vitamin2.getChemicalName())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("artcleId")) {
			sb.append("'");
			sb.append(String.valueOf(vitamin.getArtcleId()));
			sb.append("'");
		...
		if (entityFieldName.equals("chemicalName")) {
			throw new IllegalArgumentException(
				"Invalid entity field " + entityFieldName);
		}
	...
	protected Vitamin randomVitamin() throws Exception {
		return new Vitamin() {
			{
				artcleId = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
	...
	@Inject
	private com.dnebinger.headless.vitamins.resource.v1_0_0.VitaminResource
		_vitaminResource;
