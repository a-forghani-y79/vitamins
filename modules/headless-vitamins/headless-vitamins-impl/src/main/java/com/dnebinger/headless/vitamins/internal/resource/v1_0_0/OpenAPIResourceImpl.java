...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "API for accessing Vitamin detail", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Headless Vitamins", version = "V1.0.0")
)
@Path("/V1.0.0")
