package com.dnebinger.headless.vitamins.internal.graphql.query.v1_0_0;
...
public class Query {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {vitamin(vitaminId: ___){name, id, chemicalName, properties, group, description, artcleId, type, attributes, risks, symptoms, creator}}"}' -u 'test@liferay.com:test'
	 */
