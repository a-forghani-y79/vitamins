package com.dnebinger.headless.vitamins.client.serdes.v1_0_0;
...
public class VitaminSerDes {
	...
	public static String toJSON(Vitamin vitamin) {
		...
		if (vitamin.getArtcleId() != null) {
			...
			sb.append(_escape(vitamin.getArtcleId()));
		...
		if (vitamin.getChemicalName() != null) {
			...
			for (int i = 0; i < vitamin.getChemicalName().length; i++) {
				sb.append("\"");

				sb.append(_escape(vitamin.getChemicalName()[i]));

				sb.append("\"");

				if ((i + 1) < vitamin.getChemicalName().length) {
					sb.append(", ");
				}
			}
	...
	public static Map<String, String> toMap(Vitamin vitamin) {
		...
		if (vitamin.getArtcleId() == null) {
			map.put("artcleId", null);
		}
		else {
			map.put("artcleId", String.valueOf(vitamin.getArtcleId()));
		}
		...
		if (vitamin.getChemicalName() == null) {
			map.put("chemicalName", null);
		}
		else {
			map.put("chemicalName", String.valueOf(vitamin.getChemicalName()));
		}
	...
	public static class VitaminJSONParser extends BaseJSONParser<Vitamin> {
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "artcleId")) {
				if (jsonParserFieldValue != null) {
					vitamin.setArtcleId((String)jsonParserFieldValue);
				}
			}
			...
			else if (Objects.equals(jsonParserFieldName, "chemicalName")) {
				if (jsonParserFieldValue != null) {
					vitamin.setChemicalName(
						toStrings((Object[])jsonParserFieldValue));
				}
			}
