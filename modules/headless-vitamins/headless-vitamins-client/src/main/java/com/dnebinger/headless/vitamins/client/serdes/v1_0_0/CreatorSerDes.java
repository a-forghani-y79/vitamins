...
import com.dnebinger.headless.vitamins.client.dto.v1_0_0.Creator;
...
public class CreatorSerDes {
	...
	public static String toJSON(Creator creator) {
		...
		if (creator.getPeofileURL() != null) {
			...
			sb.append(_escape(creator.getPeofileURL()));
	...
	public static Map<String, String> toMap(Creator creator) {
		...
		if (creator.getPeofileURL() == null) {
			map.put("peofileURL", null);
		}
		else {
			map.put("peofileURL", String.valueOf(creator.getPeofileURL()));
		}
	...
	public static class CreatorJSONParser extends BaseJSONParser<Creator> {
		...
		protected void setField(
			...
			else if (Objects.equals(jsonParserFieldName, "peofileURL")) {
				if (jsonParserFieldValue != null) {
					creator.setPeofileURL((String)jsonParserFieldValue);
				}
			}
		}
