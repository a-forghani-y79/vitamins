...
public abstract class BaseVitaminResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-vitamins/V1.0/vitamins' -d $'{"artcleId": ___, "attributes": ___, "chemicalName": ___, "creator": ___, "description": ___, "group": ___, "id": ___, "name": ___, "properties": ___, "risks": ___, "symptoms": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-vitamins/V1.0/vitamin/{vitaminId}'  -u 'test@liferay.com:test'
	 */
	@DELETE
	@Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'DELETE' 'http://localhost:8080/o/headless-vitamins/V1.0/vitamin/batch'  -u 'test@liferay.com:test'
	 */
	@Consumes("application/json")
	@DELETE
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-vitamins/V1.0/vitamin/{vitaminId}'  -u 'test@liferay.com:test'
	 */
	@GET
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PATCH' 'http://localhost:8080/o/headless-vitamins/V1.0/vitamin/{vitaminId}' -d $'{"artcleId": ___, "attributes": ___, "chemicalName": ___, "creator": ___, "description": ___, "group": ___, "id": ___, "name": ___, "properties": ___, "risks": ___, "symptoms": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Consumes({"application/json", "application/xml"})
	@Operation(
	...
	public Vitamin patchVitamin(
		...
		if (vitamin.getArtcleId() != null) {
			existingVitamin.setArtcleId(vitamin.getArtcleId());
		}
		...
		if (vitamin.getChemicalName() != null) {
			existingVitamin.setChemicalName(vitamin.getChemicalName());
		}
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/headless-vitamins/V1.0/vitamin/{vitaminId}' -d $'{"artcleId": ___, "attributes": ___, "chemicalName": ___, "creator": ___, "description": ___, "group": ___, "id": ___, "name": ___, "properties": ___, "risks": ___, "symptoms": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
	@Consumes({"application/json", "application/xml"})
	@Operation(
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/headless-vitamins/V1.0/vitamin/batch'  -u 'test@liferay.com:test'
	 */
	@Consumes("application/json")
	@Override
	@Parameters(
